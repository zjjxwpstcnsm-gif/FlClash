...
@JsonKey(name: 'selected-map') Map<String, String> get selectedMap;@JsonKey(name: 'test-url') String get testUrl;@JsonKey(name: 'smart-failover') bool get smartFailover;@JsonKey(name: 'smart-failover-max-delay') int get smartFailoverMaxDelayMs;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SetupParams&&const DeepCollectionEquality().equals(other.selectedMap, selectedMap)&&(identical(other.testUrl, testUrl) || other.testUrl == testUrl)&&(identical(other.smartFailover, smartFailover) || other.smartFailover == smartFailover)&&(identical(other.smartFailoverMaxDelayMs, smartFailoverMaxDelayMs) || other.smartFailoverMaxDelayMs == smartFailoverMaxDelayMs));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(selectedMap),testUrl,smartFailover,smartFailoverMaxDelayMs);

@override
String toString() {
  return 'SetupParams(selectedMap: $selectedMap, testUrl: $testUrl, smartFailover: $smartFailover, smartFailoverMaxDelayMs: $smartFailoverMaxDelayMs)';
}
...
@useResult
$Res call({
@JsonKey(name: 'selected-map') Map<String, String> selectedMap,@JsonKey(name: 'test-url') String testUrl,@JsonKey(name: 'smart-failover') bool smartFailover,@JsonKey(name: 'smart-failover-max-delay') int smartFailoverMaxDelayMs
});
...
/// Create a copy of SetupParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedMap = null,Object? testUrl = null,Object? smartFailover = null,Object? smartFailoverMaxDelayMs = null,}) {
...
as String,smartFailover: null == smartFailover ? _self.smartFailover : smartFailover // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'selected-map')  Map<String, String> selectedMap, @JsonKey(name: 'test-url')  String testUrl, @JsonKey(name: 'smart-failover')  bool smartFailover, @JsonKey(name: 'smart-failover-max-delay')  int smartFailoverMaxDelayMs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SetupParams() when $default != null:
return $default(_that.selectedMap,_that.testUrl,_that.smartFailover,_that.smartFailoverMaxDelayMs);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'selected-map')  Map<String, String> selectedMap, @JsonKey(name: 'test-url')  String testUrl, @JsonKey(name: 'smart-failover')  bool smartFailover, @JsonKey(name: 'smart-failover-max-delay')  int smartFailoverMaxDelayMs)  $default,) {final _that = this;
switch (_that) {
case _SetupParams():
return $default(_that.selectedMap,_that.testUrl,_that.smartFailover,_that.smartFailoverMaxDelayMs);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'selected-map')  Map<String, String> selectedMap, @JsonKey(name: 'test-url')  String testUrl, @JsonKey(name: 'smart-failover')  bool smartFailover, @JsonKey(name: 'smart-failover-max-delay')  int smartFailoverMaxDelayMs)?  $default,) {final _that = this;
switch (_that) {
case _SetupParams() when $default != null:
return $default(_that.selectedMap,_that.testUrl,_that.smartFailover,_that.smartFailoverMaxDelayMs);case _:
  return null;
...
class _SetupParams implements SetupParams {
  const _SetupParams({@JsonKey(name: 'selected-map') required final  Map<String, String> selectedMap, @JsonKey(name: 'test-url') required this.testUrl, @JsonKey(name: 'smart-failover') this.smartFailover = false, @JsonKey(name: 'smart-failover-max-delay') this.smartFailoverMaxDelayMs = 200}): _selectedMap = selectedMap;
...
@override@JsonKey(name: 'smart-failover') final  bool smartFailover;
@override@JsonKey(name: 'smart-failover-max-delay') final  int smartFailoverMaxDelayMs;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_selectedMap),testUrl,smartFailover,smartFailoverMaxDelayMs);
...
/// Create a copy of SetupParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedMap = null,Object? testUrl = null,Object? smartFailover = null,Object? smartFailoverMaxDelayMs = null,}) {
